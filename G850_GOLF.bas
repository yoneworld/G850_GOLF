...
1101 REM DEBUG
1102 REM D=50:E=32:Y=182:Z=5:E=32:F=123:B=140:R=60
...
1230 IF INKEY$ = CHR$ 13 THEN LOCATE 0,5:PRINT "                        ": GOTO 1250
1231 IF INKEY$ ="G" THEN LOCATE 0,5:WAIT 128:PRINT " Giveup! Another Cource ": H=H-1:GOTO 1090
1240 GOTO 1210
...
1308 REM LOCATE 0,5:PRINT USING"####";Y:LOCATE 5,5:PRINT USING"####";V:LOCATE 10,5:PRINT USING"####";D:IF Y<D+25 AND Y>D THEN C=0:WAIT 64:LOCATE 20,5:PRINT "Th" :WAIT 0 ELSE LOCATE 20,5:PRINT "  "
1309 IF Y<D+25 AND Y>D THEN C=0
...
1420 IF V<D+22 AND V>D THEN GCURSOR (I-3,33):GPRINT "F2F1F0F1F2":CLS : WAIT 128:PRINT "Water...": WAIT 0:GOTO 2050
1430 ' Judgement-Tree
1440 IF V<R+6 AND V>R-6 OR (V<B+6 AND V>B-6) THEN 1610
...
1900 DS=140-(D+1)*SS: DE=140-(D+21)*SS
1910 IF DE>0 AND DE<11 THEN DE=11
1920 IF DS>0 AND DS<11 THEN DS=11
