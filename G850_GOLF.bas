...
1160 C=-(T=3)*3
1170 LOCATE 0,5:PRINT "RET:Select/G:GiveUp/Any"
1180 READ K,Q$
...
1340 IF C PRESET (I, J): A=-1: WAIT 13: V=V-O*P/2: U=46*P*O/Y: I=I+U:J=27-P/3: IF POINT (I,J) THEN IF (V<D+22 AND V>D) ELSE GOTO 1370
...
1430 ' Judgement-Tree
1440 IF (V<D+22 AND V>D) OR (V<E+13 AND V>E) OR ( V<F+13 AND V>F) ELSE IF V<R+6 AND V>R-6 OR (V<B+6 AND V>B-6) THEN 1610
